...
function adstm_breadcrumbs() {
	...
	$text = [
		'home'     => __( 'Home', 'dav2' ),
		'category' => __( '%s', 'dav2', get_the_date() ),
		'search'   => __( 'Search Results for: %s', 'dav2', get_search_query() ),
		'tag'      => __( 'Tag Archives: %s', 'dav2', single_tag_title( '', false ) ),
		'author'   => __( 'All posts by %s', 'dav2', get_the_author() ),
                'account' => __( 'Account', 'dav2' ),
                'orders'  => __( 'Orders', 'dav2' ),
		'404'      => __( 'Not Found', 'dav2' ),
		'cart'     => __( 'Cart', 'dav2' ),
	];
