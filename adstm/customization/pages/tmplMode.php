...
$curr_classic = __('You’re currently on: <b>Classic content</b>', 'dav2');
$curr_sellvia = __('You’re currently on: <b>Sellvia content</b>', 'dav2');
...
<span class="mode_btn mode_btn_1 %4$s"><button class="btn btn-blue" name="tp_create" value="true">%1$s</button></span> <span class="mode_btn mode_btn_2 %5$s"><button class="btn btn-green" name="tp_create_sellvia_mode" value="true">%2$s</button></span>
        ...
        __('Use Classic Content', 'dav2'),
        __('Use Sellvia Content', 'dav2'),
        __("Select what kind of demo content you'd like to start with. If you have Sellvia products in your store, we recommend using the content specifically adapted to Sellvia. To switch to the content developed for AliExpress products, click ‘Use Classic Content’.", 'dav2'),
        $tp_mode == 1 ? 'active' : '',
        $tp_mode == 2 ? 'active' : '',
        $tp_mode === 1 ? $curr_classic : ($tp_mode === 2 ? $curr_sellvia : ''),
        __('Please note that you need to delete your already existing utility pages (e.g. Payment Methods) before applying new content. ', 'dav2')
    )
] );
